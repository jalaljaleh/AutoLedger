...
namespace AutoLedger.Data.Mapping
{
    public class CarReceptionConfiguration : EntityTypeConfiguration<CarReception>
    {
        public CarReceptionConfiguration()
        {
            ...
            Property(a => a.CreatedAt).HasColumnType("datetime2").IsRequired();
            Property(a => a.UpdatedAt).HasColumnType("datetime2").IsRequired();

          
            Property(a => a.RepairedAt).HasColumnType("datetime2").IsOptional();
            Property(a => a.ReleasedAt).HasColumnType("datetime2").IsOptional();
